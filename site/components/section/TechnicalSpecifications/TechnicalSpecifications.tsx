...
const TechnicalSpecifications: VFC<Props> = ({ productSlug }) => {
      ...
      <div className="container-boxed">
        <div className="row">
          <div className="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 text-center">
            ...
            <a className="btn btn-primary me-3" href="https://docs.google.com/document/d/1CU2jnB3jaOifmPNesTwSE6phJu_D2K2CmjeQ3uGmMB8/edit" target="_blank" title="User Manual" rel="noreferrer">
              View User Manual
