          ...
          <div className="row">
            <div className="col-md-9 col-xl-6">
              <figure className="heading mt-lg-0">
                ...
                <p className="mt-3 mt-xl-4">Das Keyboard offers badass geeks the ultimate experience with high-performance mechanical keyboards with superior durability, construction, and design.</p>
              </figure>
            </div>
          </div>
        </div>
