...
import { Button, Text, Container } from '@archive/components/ui'
import { Bag, Cross, Check, MapPin, CreditCard } from '@archive/components/icons'
import { CartItem } from '@archive/components/cart'
