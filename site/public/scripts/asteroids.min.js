/*!
 * Asteroid game credit to http://erkie.github.com/
 */
...
that.canvas.setAttribute('width',w);that.canvas.setAttribute('height',h);}};addEvent(window,'resize',eventResize);this.gameContainer.appendChild(this.canvas);this.ctx=this.canvas.getContext('2d');this.ctx.fillStyle='red';this.ctx.strokeStyle='black';if(!document.getElementById('ASTEROIDS-NAVIGATION')){this.navigation=document.createElement('div');this.navigation.id='ASTEROIDS-NAVIGATION';this.navigation.className='ASTEROIDSYEAH';with(this.navigation.style){fontFamily='Arial,sans-serif';position='fixed';zIndex='10001';top='3px';left='10px';padding='0 5px 0 5px';border='1px solid #aaa';backgroundColor='#eee';color='blue';textAlign='right';}
this.navigation.innerHTML='Use arrow keys to move, spacebar to shoot. Click or press Esc key to exit. Score:  ';this.gameContainer.appendChild(this.navigation);this.points=document.createElement('span');this.points.id='ASTEROIDS-POINTS';this.points.style.font='28pt Arial, sans-serif';this.points.style.fontWeight='bold';this.points.className='ASTEROIDSYEAH';this.navigation.appendChild(this.points);}else{this.navigation=document.getElementById('ASTEROIDS-NAVIGATION');this.points=document.getElementById('ASTEROIDS-POINTS');}
