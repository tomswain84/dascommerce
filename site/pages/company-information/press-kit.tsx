          ...
          <div className="container">
            <div className="row">
              <div id="contentContainer" className="col">
                ...
                <p dangerouslySetInnerHTML={$html('press-kit_introduction')} />

                <h3 className="sidebar-title mt-5" dangerouslySetInnerHTML={$html('press-kit_title_1')} />
                <p dangerouslySetInnerHTML={$html('press-kit_content_1')} />

                <h3 className="sidebar-title mt-5" dangerouslySetInnerHTML={$html('press-kit_title_2')} />
                <div dangerouslySetInnerHTML={$html('press-kit_content_2')}></div>

                <h3 className="sidebar-title mt-5" dangerouslySetInnerHTML={$html('press-kit_title_3')} />
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-12 col-sm-6">
                    <p className="fw-bold mt-3 mt-sm-0 mb-0" dangerouslySetInnerHTML={{ __html: `${say('press-kit_logo_title_1')} ${say('dklogo-black')}` }} />
                    <a href="/images/press-kit/Das_Keyboard_logo_black.png" title={say('press-kit_logo')} dangerouslySetInnerHTML={$html('press-kit_logo')} />
                  </div>
                </div>
                ...
                <div className="row align-items-center pt-3 pt-sm-5">
                  ...
                  <div className="col-12 col-sm-6">
                    <p className="fw-bold mt-3 mt-sm-0 mb-0" dangerouslySetInnerHTML={{ __html: `${say('press-kit_logo_title_1')} ${say('dklogo-white')}` }} />
                    <a href="/images/press-kit/Das_Keyboard_logo_white.png" title={say('press-kit_logo')}>{say('press-kit_logo', true)}</a>
                  </div>
                </div>
                ...
                <div className="row section-pad">
                  ...
                  <div className="col-12 col-sm-6 d-flex flex-column align-items-center align-items-sm-start">
                    ...
                    <DownloadButton
                      ...
                      label={say('dk5q-front_view')} ext={say('press-kit_logo_Dk5k_3.6', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/5QS-mechanical-keyboard-Angled_Top_Right_Side_View.jpg'
                      label={say('dk5q-front_side_view')} ext={say('press-kit_logo_Dk5k_3.6', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/5QS-mechanical-keyboard-Side_View_with_Palmrest.jpg'
                      label={say('dk5q-side_view')} ext={say('press-kit_logo_Dk5k_3.6', true)}
                    />
                  </div>
                </div>
                ...
                <div className="row section-pad">
                  ...
                  <div className="col-12 col-sm-6 d-flex flex-column align-items-center align-items-sm-start">
                    ...
                    <DownloadButton
                      ...
                      label={say('top_view')} ext={say('press-kit_logo_x50_3.0', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/X50_2_front_side_full.png'
                      label={say('front_side_view')} ext={say('press-kit_logo_x50_3.6', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/X50_3_angle_side_full.png'
                      label={say('angled_side_view')} ext={say('press-kit_logo_x50_3.7', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/X50_4_side_right_full.png'
                      label={say('side_view')} ext={say('press-kit_logo_x50_3.7', true)}
                    />
                  </div>
                </div>
                ...
                <div className="row section-pad">
                  ...
                  <div className="col-12 col-sm-6 d-flex flex-column align-items-center align-items-sm-start">
                    ...
                    <DownloadButton
                      ...
                      label={say('front_view')} ext={say('press-kit_logo_Dk5k_3.6', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/daskeyboard-4q-front-side-view-press-kit.jpg'
                      label={say('front_side_view')} ext={say('press-kit_logo_Dk5k_3.6', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/daskeyboard-4q-rear-view-press-kit.jpg'
                      label={say('rear_view')} ext={say('press-kit_logo_Dk5k_3.6', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/daskeyboard-4q-side-view-press-kit.jpg'
                      label={say('side_view')} ext={say('press-kit_logo_Dk5k_3.6', true)}
                    />
                  </div>
                </div>
                ...
                <div className="row section-pad">
                  ...
                  <div className="col-12 col-sm-6 d-flex flex-column align-items-center align-items-sm-start">
                    ...
                    <DownloadButton
                      ...
                      label={say('p13-top_view')} ext={say('press-kit_logo_p13k_3.0', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/Prime-13-side-view.jpg'
                      label={say('p13-angled_side_view')} ext={say('press-kit_logo_p13_3.6', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/Prime-13-diagonal-view.jpg'
                      label={say('p13-angled_front_view')} ext={say('press-kit_logo_p13_3.7', true)}
                    />
                  </div>
                </div>
                ...
                <div className="row section-pad">
                  ...
                  <div className="col-12 col-sm-6 d-flex flex-column align-items-center align-items-sm-start">
                    ...
                    <DownloadButton
                      ...
                      label={say('front_view')} ext={say('press-kit_logo_3.1', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/daskeyboard-4-root-rear-view-press-kit.jpg'
                      label={say('rear_view')} ext={say('press-kit_logo_3.1', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/daskeyboard-4-root-side-view-press-kit.jpg'
                      label={say('side_view')} ext={say('press-kit_logo_3.1', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/daskeyboard-4-root-usb-hub-view-press-kit.jpg'
                      label={say('usb-hub')} ext={say('press-kit_logo_3.1', true)}
                    />
                  </div>
                </div>
                ...
                <div className="row section-pad">
                  ...
                  <div className="col-12 col-sm-6 d-flex flex-column align-items-center align-items-sm-start">
                    ...
                    <DownloadButton
                      ...
                      label={say('front_view')} ext={say('press-kit_logo_3.2', true)}
                    />
                    <DownloadButton
                ...
                <div className="row section-pad">
                  ...
                  <div className="col-12 col-sm-6 d-flex flex-column align-items-center align-items-sm-start">
                    ...
                    <DownloadButton
                      ...
                      label={say('usb-hub')} ext={say('press-kit_logo_3.2', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/DasKeyboard-S-professional_front_view.png'
                      label={say('media-keys')} ext={say('press-kit_logo_3.2', true)}
                    />
                    <DownloadButton
                      href='/images/press-kit/DasKeyboard-S-professional_front_view_with_reflection.png'
                      label={say('media-keys-reflection')} ext={say('press-kit_logo_3.2', true)}
                    />
                  </div>
                </div>
